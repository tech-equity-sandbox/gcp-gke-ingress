...
Navigate to `https://console.cloud.google.com/kubernetes/ingresses?project={{project-id}}` to explore the ingress on the console.

Navigate to `https://console.cloud.google.com/net-services/loadbalancing/list/loadBalancers?project={{project-id}}` to explore the load LoadBalancer on the console.
...
Navigate to `https://console.cloud.google.com/kubernetes/ingresses?project={{project-id}}` to explore the managed certificate on the console.
